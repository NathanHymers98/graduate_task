...
class ChatRoomController extends AbstractController
{
     ...
     */
    public function chatRoom(User $recipient, Request $request, NormalizerInterface $normalizer, FireBaseService $fireBaseService, UserRepository $userRepository, EntityManagerInterface $entityManager)
    {
