 ...
 */
final class Version20200928062624 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE message (chat_room_id VARCHAR(255) NOT NULL, content VARCHAR(255) NOT NULL, sender_id INT NOT NULL, recipient_id INT NOT NULL, sent_at DATETIME NOT NULL, seen VARCHAR(255) NOT NULL, email_sent VARCHAR(255) NOT NULL, PRIMARY KEY(chat_room_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
